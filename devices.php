    ...
    <body bgcolor="#666699">
      ...
      <div id="menu" style="background-color:#FFFF66;height:550px;width:200px;float:left;">   
            ...
            <center>
                    ...
                    <font face='arial' size='5'>
                        <p align='center'>
                        Welcome! <br> Here you can add the network devices and also select the particular
                        interfaces which you want to probe. Additionally, you can also monitor and delete the devices
